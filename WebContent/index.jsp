    ...
    <div class="container">
      <div class="row">
        ...
        <%for(int i=0;i<name.size();i++){ %>
	        <div class="docList col-md-3 col-sm-3 col-xs-6">
	          <div class="thumbnail">
	            <img src="img/doctor.jpg" alt="..." class="team-img">
	            <div class="caption">
	              <h3><%=name.get(i)%></h3>
	              <p>Doctor</p>
        ...
        <div class="col-md-8 col-sm-8 marb20">
          <div class="contact-info">
            ...
            <form action="" method="post" role="form" class="contactForm">
                ...
                Are you a existing customer:<br>
              ...
              <div class="form-group" id="exixtingCustomerTB">
                <input type="text" name="exixtingCustomerTB" class="form-control br-radius-zero" placeholder="Case paper ID" data-rule="minlen:7" data-msg="Please enter at least 7 chars" />
              ...
              <div class="form-group">
                <input type="text" class="form-control br-radius-zero" name="mobile" id="mobile" placeholder="Your Mobile No" data-rule-minlength="10" data-rule-maxlength="10" data-rule-digits="true" data-msg="Please enter a valid number" />
                <div class="validation"></div>
              </div>
              <div class="form-group">
                <input type="text" class="form-control br-radius-zero" name="email" id="email" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" />
                <div class="validation"></div>
              </div>
              <div class="form-group">
                <div class="col-sm-6">
              ...
              <div class="form-group" id="medicationDetails">
                <textarea class="form-control br-radius-zero"  rows="5"  placeholder="Enter medication details here"></textarea>
              </div>

              <div class="form-action">
                <button type="submit" class="btn btn-form">Book Appointment</button>
              </div>
            </form>
          </div>
        </div>
...
<script>
	$(document).ready(function(){
		...
		$('#exixtingCustomerTB').hide();
		
	});
	
	$("input:radio[name=medication]").click(function(){
		if($(this).val()=='yes'){
